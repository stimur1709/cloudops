...
public class CredentialEntity {
    ...
    private CredentialEntity(OrganizationEntity organization, String name, CredentialType type, String username,
            String secretEncrypted, Instant now) {
    ...
    public static CredentialEntity create(OrganizationEntity organization, String name, CredentialType type,
            String username, String secretEncrypted, Instant now) {
    ...
    public String secretEncrypted() { return secretEncrypted; }
