...
public final class CredentialSearchDefinition {
    public static final JpaSearchDefinition<CredentialEntity> DEFINITION = JpaSearchDefinition.builder(
            ...
            .field(
                    ...
                    JpaSearchField.<CredentialEntity>text(root -> root.get(CredentialEntity_.NAME))
                            .sortable())
            .field(
            ...
            .field(
                    ...
                    JpaSearchField.<CredentialEntity>text(root -> root.get(CredentialEntity_.USERNAME))
                            .sortable())
            .field(
