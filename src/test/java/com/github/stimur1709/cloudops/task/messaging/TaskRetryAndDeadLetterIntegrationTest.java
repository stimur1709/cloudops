...
import com.github.stimur1709.cloudops.task.application.RetryableTaskExecutionException;
import com.github.stimur1709.cloudops.task.application.TaskExecutionContext;
import com.github.stimur1709.cloudops.task.application.TaskExecutionResult;
import com.github.stimur1709.cloudops.task.application.TaskHandler;
import com.github.stimur1709.cloudops.task.application.TaskHandlerNotFoundException;
import com.github.stimur1709.cloudops.task.application.TaskHandlerRegistry;
...
class TaskRetryAndDeadLetterIntegrationTest {
    ...
    private long insertTerminalTask() {
        return jdbcTemplate.queryForObject("""
                ...
                VALUES (?, ?, 'HTTP_CHECK', 'COMPLETED', ?, now(), now(), now()) RETURNING id
                """, Long.class, organizationId, resourceId, TestAuthentication.USER_ID);
    }
