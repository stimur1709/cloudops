...
public final class UserSearchDefinition {
    ...
    public static final JpaSearchDefinition<UserEntity> DEFINITION = JpaSearchDefinition.builder(UserEntity.class)
            .field(
                    UserEntity_.ID,
            ...
            .field(
                    UserEntity_.EMAIL,
                    JpaSearchField.<UserEntity>text(root -> root.get(UserEntity_.email))
                            .sortable())
            .field(
                    UserEntity_.DISPLAY_NAME,
                    JpaSearchField.<UserEntity>text(root -> root.get(UserEntity_.displayName))
                            .sortable())
            .field(
