...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ApiError> handleUnreadableBody(
        ...
        return response(HttpStatus.BAD_REQUEST, "INVALID_REQUEST", "Request body is invalid", request, errors);
    }
    ...
    ResponseEntity<ApiError> handleEndpointNotFound(HttpServletRequest request) {
        return response(HttpStatus.NOT_FOUND, "ENDPOINT_NOT_FOUND", "Endpoint not found", request, List.of());
    }
